...
urlpatterns = [
     ...
     path('<pk>/',view.UserQnListView.as_view()),  #userspecific list pass id  
     path('<pk>/skilllist/',view.SkillQnDetailsView.as_view()),   #specific list
     path('list/',view.QuestionListView.as_view()),  #question list   
]
